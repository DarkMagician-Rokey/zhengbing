...
//证件验证
function password1() {
    document.getElementById("password1").innerHTML = "请输入注册时填写的证件号码";
}
function password2() {
...
//姓名验证
function name1() {
    document.getElementById("span2").innerHTML = "请输入注册时填写的姓名";
}
function name2() {
...
function login() {
    ...
    {
        document.getElementById("span2").innerHTML='<span class="error">姓名不能为空</span>';
        return false;
    }else if(y=="")
    {
...
function yanzhengma1() {
    document.getElementById("span3").innerHTML = "请输入验证码";
