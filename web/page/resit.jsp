...
<div class="wenti">
    ...
    <div class="form">
        <form action="/ServletEditPersonal" method="post" id="form1">
            <input type="text" name="zhaopian" id="zhaopian" hidden>
            <div class="sex">
                <input type="radio"  name="sex" value="${UserSex}" checked>${UserSex}
                <input type="radio"  name="sex" value="${UserSex2}">${UserSex2}
            </div>
            ...
            <div class="Demo">
                ...
                <select name="UserSecurityQuestion1" id="UserSecurityQuestion1" class="intext2">
                    <option value="请选择">${UserSecurityQuestion1}</option>
            ...
            <div class="Demo">
                ...
                <span class="daan">答案</span>
                <input type="text" name="Answer2" class="intext gaizhu" value="${UserAnswer2}">
            ...
            <div class="Demo">
                ...
                <select name="UserSecurityQuestion3" id="UserSecurityQuestion3" class="intext2" onchange="func3()">
                    <option value="请选择">${UserSecurityQuestion3}</option>
                    <option value="您母亲的姓名是?">您母亲的姓名是?</option>
                    <option value="您配偶的生日是?">您配偶的生日是?</option>
                    <option value="您的学号(或工号)是?">您的学号(或工号)是?</option>
                    <option value="您母亲的生日是?">您母亲的生日是?</option>
                ...
                <span class="daan">答案</span>
                <input type="text" name="Answer3" class="intext gaizhu" value="${UserAnswer3}">
        ...
        <div class="wendidi">
            ...
            <div class="wenzhang">
                <input type="submit" value="修改信息" class="zhuce"
                       onclick="login()"
                >
